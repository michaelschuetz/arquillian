...
/**
 * JBossASSuiteContextAppender
 *
 * @author <a href="mailto:aslak@redhat.com">Aslak Knutsen</a>
 * @version $Revision: $
 */
public class JBossASSuiteContextAppender implements SuiteContextAppender
{
   /* (non-Javadoc)
   ...
   {
      context.register(BeforeSuite.class, new ServiceDeployer());
      context.register(AfterSuite.class, new ServiceUnDeployer());
   }
}
