...
/**
 * JBossASClassContextAppender
 *
 * @author <a href="mailto:aslak@redhat.com">Aslak Knutsen</a>
 * @version $Revision: $
 */
public class JBossASClassContextAppender implements ClassContextAppender
{
   /* (non-Javadoc)
   ...
   {
      context.register(AfterDeploy.class, new ReplaceContainerMethodExecutor());      
   }
}
