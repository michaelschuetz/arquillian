...
/**
 * JCloudsSuiteContextAppender
 *
 * @author <a href="mailto:aslak@redhat.com">Aslak Knutsen</a>
 * @version $Revision: $
 */
public class JCloudsSuiteContextAppender implements SuiteContextAppender
{
   /* (non-Javadoc)
   ...
   {
      context.register(BeforeStart.class, new CloudStarter());
      context.register(AfterStop.class, new CloudStopper());
   }
}
