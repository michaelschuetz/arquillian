 ...
 * @version $Revision: $
 */
public class DefaultTemplateCreator implements TemplateCreator
{
   /* (non-Javadoc)
    * @see org.jboss.arquillian.container.jclouds.spi.TemplateCreator#createTemplate(org.jboss.arquillian.container.jclouds.JCloudsConfiguration, org.jclouds.compute.ComputeService)
    */
   public Template createTemplate(JCloudsConfiguration config, ComputeService computeService)
   {
