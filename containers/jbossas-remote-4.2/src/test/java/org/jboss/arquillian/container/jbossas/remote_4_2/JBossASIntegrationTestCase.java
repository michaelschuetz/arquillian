 ...
 * @version $Revision: $
 */
@Ignore // TODO: Add auto extract of 4.2 container.  
   ...
   public static EnterpriseArchive createDeployment() throws Exception 
   {
      return ShrinkWrap.create(EnterpriseArchive.class, "test.ear")
               .addModule(
                ...
                // We need to add the Arquillian added protocol war module
               .setApplicationXML(
                     new StringAsset(
                           "<application>" +
                              "<module><ejb>test.jar</ejb></module>" +
                              "<module><web><web-uri>arquillian-protocol.war</web-uri><context-root>/arquillian-protocol</context-root></web></module>" +
                           "</application>"));
   }
